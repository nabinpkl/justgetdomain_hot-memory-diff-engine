...
export function LinkedInBlock() {
  return (
    <section className="py-16 px-6 border-t border-jgd-border">
      <div className="max-w-[480px] mx-auto text-center">
        <p className="font-serif text-[1.15rem] text-jgd-text mb-2">
          Built by Nabin Pokhrel
        </p>
        <p className="text-[0.85rem] text-jgd-dim leading-[1.6] mb-5">
          Portfolio project exploring domain discovery UX.
        </p>
        <a
